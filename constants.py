...
import astrology_signs as sign
import astrology_aspects as asp
import astrology_planets as planet

THE_SIGNS = (sign.aries, sign.taurus, sign.gemini, sign.cancer, sign.leo, sign.virgo, sign.libra, sign.scorpio, sign.sagittarius, sign.capricorn, sign.aquarius, sign.pisces)
...
SIGNS_DEGREE_BASE = {'ARIES' : 0, 'TAURUS' : 30, 'GEMINI' : 60, 'CANCER' : 90, 'LEO' : 120, 'VIRGO' : 150 , 'LIBRA' : 180, 'SCORPIO' : 210, 'SAGITTARIUS' : 240, 'CAPRICORN' : 270, 'AQUARIUS' : 300, 'PISCES' : 330}
...
SIGN_ASPECT = {'ARIES' : 'TRINE', 'TAURUS' : 'SQUARE', 'GEMINI' : 'SEXTILE', 'CANCER' : 'SEMISEXTILE', 'LEO' : 'CONJ', 'VIRGO': 'SEMISEXTILE', 'LIBRA' : 'SEXTILE', 'SCORPIO' : 'SQUARE', 'SAGITTARIUS' : 'TRINE', 'CAPRICORN' : 'QUINCUNX', 'AQUARIUS' : 'OPPOSITION', 'PISCES' : 'QUINCUNX' }

SIGN_ELEMENT = {'ARIES' : 'FIRE', 'TAURUS' : 'EARTH', 'GEMINI' : 'AIR', 'CANCER' : 'WATER', 'LEO' : 'FIRE', 'VIRGO': 'EARTH', 'LIBRA' : 'AIR', 'SCORPIO' : 'WATER', 'SAGITTARIUS' : 'FIRE', 'CAPRICORN' : 'EARTH', 'AQUARIUS' : 'AIR', 'PISCES' : 'WATER' }

SIGN_MODE = {'ARIES' : 'CARDINAL', 'TAURUS' : 'FIXED', 'GEMINI' : 'MUTABLE', 'CANCER' : 'CARDINAL', 'LEO' : 'FIXED', 'VIRGO': 'MUTABLE', 'LIBRA' : 'CARDINAL', 'SCORPIO' : 'FIXED', 'SAGITTARIUS' : 'MUTABLE', 'CAPRICORN' : 'CARDINAL', 'AQUARIUS' : 'FIXED', 'PISCES' : 'MUTABLE' }
...
SIGN_SCORE = {'ARIES' : 1, 'TAURUS' : 2, 'GEMINI' : 3, 'CANCER' : 4, 'LEO' : 5, 'VIRGO': 6, 'LIBRA' : 7, 'SCORPIO' : 8, 'SAGITTARIUS' : 9, 'CAPRICORN' : 10, 'AQUARIUS' : 11, 'PISCES' : 12 }
