...
SIGNS = ['ARIES', 'TAURUS', 'GEMINI', 'CANCER', 'LEO', 'VIRGO', 'LIBRA', 'SCORPIO', 'SAGITARRIUS', 'CAPRICORN',
         'AQUARIUS', 'PISCES']
...
ASPECT_WEIGHTS = {'CONJ': 3, 'SEMISEXTILE': 1, 'SEXTILE': 5, 'SQUARE': -5, 'TRINE': 10, 'QUINCUNX': -1, 'OPPOSITION': -10,
...
SIGNS_DEGREE_BASE = {'ARIES': 0, 'TAURUS': 30, 'GEMINI': 60, 'CANCER': 90, 'LEO': 120, 'VIRGO': 150, 'LIBRA': 180,
                     'SCORPIO': 210, 'SAGITARRIUS': 240, 'CAPRICORN': 270, 'AQUARIUS': 300, 'PISCES': 330}
...
SIGN_ASPECT = {'ARIES': 'TRINE', 'TAURUS': 'SQUARE', 'GEMINI': 'SEXTILE', 'CANCER': 'SEMISEXTILE', 'LEO': 'CONJ',
               'VIRGO': 'SEMISEXTILE', 'LIBRA': 'SEXTILE', 'SCORPIO': 'SQUARE', 'SAGITARRIUS': 'TRINE',
...
SIGN_ELEMENT = {'ARIES': 'FIRE', 'TAURUS': 'EARTH', 'GEMINI': 'AIR', 'CANCER': 'WATER', 'LEO': 'FIRE', 'VIRGO': 'EARTH',
                'LIBRA': 'AIR', 'SCORPIO': 'WATER', 'SAGITARRIUS': 'FIRE', 'CAPRICORN': 'EARTH', 'AQUARIUS': 'AIR',
                'PISCES': 'WATER'}

SIGN_MODE = {'ARIES': 'CARDINAL', 'TAURUS': 'FIXED', 'GEMINI': 'MUTABLE', 'CANCER': 'CARDINAL', 'LEO': 'FIXED',
             'VIRGO': 'MUTABLE', 'LIBRA': 'CARDINAL', 'SCORPIO': 'FIXED', 'SAGITARRIUS': 'MUTABLE',
...
SIGN_SCORE = {'ARIES': 1, 'TAURUS': 2, 'GEMINI': 3, 'CANCER': 4, 'LEO': 5, 'VIRGO': 6, 'LIBRA': 7, 'SCORPIO': 8,
              'SAGITARRIUS': 9, 'CAPRICORN': 10, 'AQUARIUS': 11, 'PISCES': 12}

GARMENTS = ['HAT', 'SCARF', 'COWL']
GARMENT_ST_TO_DEGREES = {'HAT': 3, 'SCARF': 1, 'COWL': 2}
